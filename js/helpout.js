	...
	function checkSession()
	{
      ...
      content += "<li><a href='#' style=''>My Profile</a></li>";
	...
	$("#signup").submit(function(event) { // needs form to have id signup_student and to have jquery, like src links above 
      ...
      success: function(results) {
        ...
        console.log("Result" + results);
				...
				eventsList = results;
				generateEventTiles(results, "tiles_events");
      ...
      error: function(error) {
		...
		{
			var query = new Parse.Query(Event);
			query.equalTo("event_owner", Parse.User.current);
    	query.find({
      success: function(results) {
        console.log("Successfully retrieved " + results.length);
        // Do something with the returned Parse.Object values.
        console.log("Result" + results);
				...
				eventsList = results;
				generateEventTiles(results, "tiles");
